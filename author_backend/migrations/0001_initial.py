# Generated by Django 3.2.6 on 2021-10-06 12:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(verbose_name='url')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='author_backend.category', verbose_name='Категория стиха')),
                ('consecrated', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='author_backend.consecrated', verbose_name='Кому посвящається')),
            ],
            options={
                'ordering': ('-date_add',),
            },
